...
//     if (!formData.image.trim() && !selectedImage) {
...
//         })
//       );
//       submitData.append("income", Number(formData.income));
//       submitData.append("handlingFee", formData.handlingFee);
...
//                 <div>
//                   <label className="block text-sm font-medium text-gray-700 mb-1">
//                     Image Input <span className="text-red-500">*</span>
//                   </label>
...
//                     {/* Selected File Info */}
//                     {selectedImage && (
//                       <div className="text-sm text-gray-600 bg-green-50 p-2 rounded-md">
...
//                 <div>
//                   <label className="block text-sm font-medium text-gray-700 mb-1">
//                     Stack Percentage <span className="text-red-500">*</span>
//                   </label>
//                   <input
//                     type="number"
//                     name="income"
...
const ProductsPage = () => {
  ...
  const handleAddProduct = async (e) => {
    ...
    try {
      ...
      submitData.append("income", Number(formData.income));
      submitData.append("duration", Number(formData.duration)); // 🔥 Add duration
      submitData.append("handlingFee", formData.handlingFee);
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Number of days users will receive income from this product
                  </p>
                </div>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {products.length === 0 ? (
                  <tr>
                    <td colSpan="9" className="px-6 py-12 text-center"> {/* Updated colspan to 9 */}
                      <div className="text-gray-400">
                        <Package className="mx-auto h-12 w-12" />
                        <h3 className="mt-2 text-sm font-medium text-gray-900">
                          No products found
            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  {/* 🔥 NEW: Duration field in modal */}
                  <div>
                    <label className="block text-sm font-medium text-gray-700">
                      Duration
                    </label>
                    <span className="mt-1 inline-flex px-2 py-1 text-sm font-semibold rounded-full bg-purple-100 text-purple-800 items-center gap-1">
                      <Clock className="w-3 h-3" />
                      {detailsModal.duration || 7} days
                    </span>
                  </div>
